...
* 2023 SCON 대회장 사진은 **[구글 드라이브](https://drive.google.com/drive/folders/12FTGj6h4jIz_SUtnLPjteL8Qjyk3kDXW?usp=sharing)**에서 확인하실 수 있습니다.
* 2023 SCON 문제지, 해설, 모범 코드는 **[깃허브](https://github.com/ssu-sccc/2023scon)**에서 확인하실 수 있습니다.

<img src="/assets/images/2023scon.png" alt="2023scon-poster" width="50%" style="display: block; margin: 0 auto;">
...
* [숭실대학교 FUN 시스템](https://fun.ssu.ac.kr/ko/program/all/view/3386) **숭실대학교 프로그래밍대회 (2023 SCON) 안내** 참가 신청
...
* [예시 1](https://github.com/justiceHui/icpc-teamnote/blob/master/main.pdf), [예시 2](https://github.com/green5555/Teamnote-archive/blob/main/2019%20ICPC%20-%20Advanced%20Algorithm%20Study.pdf), [예시 3](https://zigui.tistory.com/5), [예시 4](https://github.com/kth-competitive-programming/kactl/blob/main/kactl.pdf)
...
* 문제 풀이에 사용되는 모든 코드는 대회 시간 안에 작성되어야 합니다.
  ...
  * 팀 레퍼런스 문서에 없는 [AtCoder Library](https://github.com/atcoder/ac-library)와 같은 미리 작성된 코드는 사용할 수 없습니다.
...
* 본 대회와 동시에 동일한 문제로 Baekjoon Online Judge에서 진행되는 [Open Contest](https://www.acmicpc.net/contest/view/999)에 제출하는 경우 실격 처리
