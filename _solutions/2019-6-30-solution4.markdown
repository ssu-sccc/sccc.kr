...
만약에 소 [A(1), B(1)]을 선택했다고 해 보자. 그러면

 T  ... B(1) B(1)+1 ... B(2) B(2)+1 ...
-1  ...  -1     0   ...  0     0    ...

시간 [T,B(1)]에 대해서, 건널 수 있는 소가 하나 줄어든다. 그런데, 소 [A(2), B(2)]를 선택했다면

 T  ... B(1) B(1)+1 ... B(2) B(2)+1 ...
-1  ...  -1     -1   ... -1     0   ...

시간 [T,B(2)]에 대해서, 건널 수 있는 소가 하나 줄어든다. 

시간 (B(1), B(2)]에 도와줄 수 있는 닭의 입장에서는, 소 1마리를 선택할 기회를 잃어버리게 되는 셈이다.
